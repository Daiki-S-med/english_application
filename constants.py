...
# {level} にユーザーの英語レベル（初級者/中級者/上級者）を渡して使用する
SYSTEM_TEMPLATE_BASIC_CONVERSATION = """
    ...
    Adjust your responses according to the level:
    - 初級者 (Beginner): Use simple vocabulary and short sentences. Avoid complex grammar. Correct only major errors gently, with brief and easy-to-understand explanations.
    - 中級者 (Intermediate): Use natural conversational English with moderate vocabulary. Gently correct errors and briefly explain nuances when appropriate.
    - 上級者 (Advanced): Use rich vocabulary, idiomatic expressions, and natural native-level language. Point out subtle errors and explain advanced nuances.
...
SYSTEM_TEMPLATE_CREATE_PROBLEM = """
    ...
    The user's English level is: {level}
    Adjust the sentence complexity according to the level:
    - 初級者 (Beginner): Use basic, common vocabulary with a simple sentence structure. Approximately 8-10 words.
    - 中級者 (Intermediate): Use natural conversational expressions with moderate complexity. Approximately 12-15 words.
    - 上級者 (Advanced): Use idiomatic expressions or rich vocabulary with more complex structure. Approximately 15-20 words.
    ...
    Limit your response to only the English sentence with no additional explanation.
"""
